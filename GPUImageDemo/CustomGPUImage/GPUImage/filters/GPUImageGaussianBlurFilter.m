...
//    DLog(@"Max varyings: %d", [GPUImageContext maximumVaryingVectorsForThisDevice]);
...
//        DLog(@"Blur radius: %f, calculated sample radius: %d", _blurRadiusInPixels, calculatedSampleRadius);
//        
...
//        DLog(@"Optimized vertex shader: \n%@", newGaussianBlurVertexShader);
//        DLog(@"Optimized fragment shader: \n%@", newGaussianBlurFragmentShader);
//        
